...
ABILITY_OFFSET_BY_AGE = list(map(lambda x: x / 50, range(-50, 0, 1))) + [0 for k in range(190)] + list(
    map(lambda x: x / 100, range(0, -50, -1)))
MATING_OFFSET_BY_AGE = list(map(lambda x: x / 50, range(-50, 0, 1))) + [0 for k in range(190)] + list(
    map(lambda x: x / 100, range(0, -50, -1)))
MARRY_OFFSET_BY_AGE = list(map(lambda x: x / 50, range(-50, 0, 1))) + [0 for k in range(190)] + list(
    map(lambda x: x / 100, range(0, -50, -1)))
